export default function InternetCard({ label, price, desc, speed, fup, support }) {
  ...
  const nomorWA = "6282323239243"; // ganti dengan nomor WA admin kamu
  ...
  return (
    <div className="bg-white rounded-2xl shadow-md p-8 max-w-sm mx-auto text-center border border-gray-100 hover:shadow-lg transition">
      ...
      <p className="text-gray-500 text-xs md:text-sm mb-4">{desc}</p>

      <div className="text-xl md:text-3xl font-bold text-blue-600 mb-4">{price}</div>

      <ul className="text-sm text-gray-700 space-y-2 mb-6">
        <li> Speed: <span className="font-medium">{speed}</span></li>
        <li> Internet Protocol: <span className="font-medium">Dynamic IP</span></li>
        <li> Device: <span className="font-medium">{fup}</span></li>
        <li> Dukungan: <span className="font-medium">{support}</span></li>
         <li> Biaya Pemasangan: <span className="font-medium">Free Pemasangan</span></li>
      </ul>
